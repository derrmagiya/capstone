...
from fitness_tracker.forms import UserLoginForm
from fitness_tracker.models import User, db, check_password_hash
    ...
    try:
        if request.method == "POST" and userform.validate_on_submit():
            ...
            if logged_user and check_password_hash(logged_user.password, password):
                ...
                flash('you are succesfully logged in via: Email/Password', 'auth-success')
